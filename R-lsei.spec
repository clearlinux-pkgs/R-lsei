...
Version  : 1.2.0.1
Release  : 17
URL      : https://cran.r-project.org/src/contrib/lsei_1.2-0.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/lsei_1.2-0.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589825780
